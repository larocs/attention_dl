...
QUERY_URL = "https://arxiv.org/search/advanced?advanced=&terms-0-operator=AND&terms-0-term=social+network+content&terms-0-field=title&terms-1-operator=OR&terms-1-term=social+network+spread&terms-1-field=title&terms-2-operator=OR&terms-2-term=social+network+diffusion&terms-2-field=title&terms-3-operator=OR&terms-3-term=social+network+content&terms-3-field=abstract&terms-4-operator=OR&terms-4-term=social+network+spread&terms-4-field=abstract&terms-5-operator=OR&terms-5-term=social+network+diffusion&terms-5-field=abstract&terms-6-operator=OR&terms-6-term=social+network+post&terms-6-field=title&terms-7-operator=OR&terms-7-term=social+network+post&terms-7-field=abstract&terms-8-operator=OR&terms-8-term=social+network+media&terms-8-field=title&terms-9-operator=OR&terms-9-term=social+network+media&terms-9-field=abstract&terms-10-operator=OR&terms-10-term=social+network+bubble&terms-10-field=title&terms-11-operator=OR&terms-11-term=social+network+microbubble&terms-11-field=title&terms-12-operator=OR&terms-12-term=social+network+community&terms-12-field=title&terms-13-operator=OR&terms-13-term=social+network+bubble&terms-13-field=abstract&terms-14-operator=OR&terms-14-term=social+network+microbubble&terms-14-field=abstract&terms-15-operator=OR&terms-15-term=social+network+community&terms-15-field=abstract&classification-computer_science=y&classification-physics=y&classification-physics_archives=all&classification-include_cross_list=include&date-year=&date-filter_by=date_range&date-from_date=2014&date-to_date=2022&date-date_type=announced_date_first&abstracts=show&size=200&order=-announced_date_first"
